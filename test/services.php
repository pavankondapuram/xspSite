...
<div class="bgWrap">
  <div class="header">
    ...
    <div class="headCont"><img src="images/logo.png" class="logoPrime" alt="XSP" width="100" />
      <nav>
        <a href="index" class="overviewB "> <span class="pop">overview</span> </a> <a href="services" class="servicesB select"> <span class="pop">our services</span> </a> <a href="ways" class="ways"> <span class="pop">our ways</span> </a> <a href="about" class="about"> <span class="pop">about xsp</span> </a> <a href="contact" class="contact"> <span class="pop">contact us</span> </a>
      </nav>
    </div>
  </div>
  <br>
