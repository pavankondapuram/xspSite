...
<div class="bgWrap">
  <div class="header">
    ...
    <div class="headCont"><img src="images/logo.png" class="logoPrime" alt="XSP" width="100" />
      <nav>
        <div> <a href="index" class="overviewB "> <span class="pop">overview</span> </a> <a href="services" class="servicesB"> <span class="pop">our services</span> </a> <a href="ways" class="ways"> <span class="pop">our ways</span> </a> <a href="about" class="about select"> <span class="pop">about xsp</span> </a> <a href="contact" class="contact"> <span class="pop">contact us</span> </a> </div>
      </nav>
    </div>
  </div>
  <br>
            ...
            <div class="panel">
              ...
              <div class="founders">
                <div class="person">
                  ...
                  <p class="textAlignCenter"> <img src="images/arjun.png" width="150"></p>
                  <p> Arjun has worked on widely admired platforms and the goal is informal for ever: To lead the design of the project into specific attribute and bring it alive with highest level of exact correspondence with fact. </p>
                  <p> Arjun Specializes in PHP and MySql, HTML 5, Action Script, Javascript and Content Writing. Over the years Arjun has experienced in building simple Content management system to complex E-commerce applications. Arjun enjoys learning new things and delivering elegant solutions that exceed expectations. </p>
                </div>
                <div class="person">
                  <h3>Pavan</h3>
                  <span class="strong"> Chief Designer</span>
                  <p class="textAlignCenter"><img src="images/pavan.png" width="150"></p>
                  <p> Pavan has wide work experience with Oracle, Philips, Trellisys and more firms. He is a graduate in Fine arts, specialized in layout designing and Diploma in interface development with experience working on designing and developing User Interfaces for web, mobile web, native mobile, eCommerce and CMS applications. </p>
                  <p> Pavan’s goal is to cater the growing necessity for unique, better and innovative User interfaces with singular focus on maximum user experience. Pavan loves to hang around with computer, designing and coding all time. </p>
                </div>
              </div>
            </div>
          </div>
