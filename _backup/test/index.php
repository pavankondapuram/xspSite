...
<div class="bgWrap">
  <div class="header">
    ...
    <div class="headCont"><img src="images/logo.png" class="logoPrime" alt="XSP" width="100" />
      <nav>
        <div> <a href="index" class="overviewB select"> <span class="pop">overview</span> </a> <a href="services" class="servicesB"> <span class="pop">our services</span> </a> <a href="ways" class="ways"> <span class="pop">our ways</span> </a> <a href="about" class="about"> <span class="pop">about xsp</span> </a> <a href="contact" class="contact"> <span class="pop">contact us</span> </a> </div>
      </nav>
    </div>
  </div>
  <br>
  ...
  <section class="wrapper">
    <div class="overview">
      ...
      <div class="part">
        <h2>About XSP</h2>
        <p>XSP &lt; XtraSensoryPerception &frasl;&gt;  started as the joint operation between designer and developer. To encompass the proper user experience and functionality of any pretty things on the web, both designer and developer plays the major role to combine and build pretty things. Find out more about the two founders, Arjun and Pavan.</p>
        <a href="about" class="button marginT10 floatR">Read more...</a> </div>
