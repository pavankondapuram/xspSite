...
<style>label.error { width: 600px; display: inline; color: red;}</style>
</head>
<body>
<div class="bgWrap">
  <div class="header">
    ...
    <div class="headCont"><img src="images/logo.png" class="logoPrime" alt="XSP" width="100" />
      <nav>
        <div> <a href="index" class="overviewB "> <span class="pop">overview</span> </a> <a href="services" class="servicesB"> <span class="pop">our services</span> </a> <a href="ways" class="ways"> <span class="pop">our ways</span> </a> <a href="about" class="about"> <span class="pop">about xsp</span> </a> <a href="contact" class="contact select"> <span class="pop">contact us</span> </a> </div>
      </nav>
    </div>
  </div>
  <br>
        ...
        <div id="main-photo-slider" class="csw">
          <div class="panelContainer coda-slider preload" id="coda-slider-1">
            <div class="panel">
              <h1>Contact us</h1>
              <div class="contactUs">
<div class="needField" id="results">
...
<input class="input" name="name" type="text" placeholder="Name" ><br/>
       
<input class="input" name="contact_no" type="text" placeholder="Contact number"><br/>
       
<input class="input" name="email" type="text" placeholder="eMail"><br/>
       
<textarea class="input" placeholder="Message" style="height:60px;" name="message"></textarea><br/>
